        ...
        if turn == 0:
            ...
            #      Board.print_board(board)
                    if Winning_move.win(board, 1): #We check if it is a winning game!
                                ...
                                minmax.thisdic = {} 
                                return False   # We return false if and only if the player 1 wins (A.I has to either win or get a draw), we need to modify something if the test comes out as negative!
                                break
                else:
            ...
            if Winning_move.win(board, 2):
                ...
                print("Player 2 wins!")
                end_of_the_game = False
                return True #we want our test to get a true answer!
